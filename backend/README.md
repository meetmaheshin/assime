...
FastAPI + PostgreSQL (pgvector) + Redis backend for **AARTH** (Artificial
Assistant & Reconciliation To Human), an AI Personal Assistant. Implements the MVP v1 core: multi-user auth, tasks/projects,
