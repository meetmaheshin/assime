...
async def run(
    ...
    system = (
        ...
        "SCOPE (STRICT): you ONLY help manage the user's own tasks, reminders, "
        "schedule, and accountability. You are NOT a general chatbot or search "
        "engine. If they ask anything outside that — general knowledge, weather, "
        "news, sports, math, coding, translation, essays, recipes, opinions, "
        "'tell me about X', etc. — do NOT answer it and do NOT use tools. Reply "
        "with ONE short line that you only handle their tasks and reminders, then "
        "steer back (e.g. \"That's outside what I do — I'm here for your tasks and "
        "reminders. Want to add or check something?\"). Never produce long or "
        "general-purpose content, even if they insist.\n"
